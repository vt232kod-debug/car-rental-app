...
async function main() { // then we wrote a async function for inserting data
  ...
  data: [
    ...
    },
    {
      ...
      category: "SPORTS",
      pricePerDay: 120,
      image: "https://images.unsplash.com/photo-1547744152-14d985cb937f?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    },
    {
      ...
      category: "ELECTRIC",
      pricePerDay: 85,
      image: "https://images.unsplash.com/photo-1657585558823-6dfb46228f60?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
