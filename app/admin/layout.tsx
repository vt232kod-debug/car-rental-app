    ...
    <div className='flex min-h-screen bg-background'>
      ...
      <aside className='hidden lg:flex w-56 shrink-0 border-r border-border bg-surface flex-col py-6 px-3'>
        ...
        <div className='mt-auto border-t border-border pt-4 px-3'>
          ...
          <LogoutButton className='mt-3 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-muted transition-all hover:bg-surface-alt hover:text-foreground' />
        </div>
      </aside>
